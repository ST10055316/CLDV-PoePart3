...
namespace EventEase.Controllers
{
    public class BookingController : Controller
    {
        ...
        // Part 2: Filter functionality
        public async Task<IActionResult> Filter(string searchTerm, DateTime? startDate, DateTime? endDate, int? venueId, string status)
        {
            ...
            ViewData["FilterTerm"] = searchTerm; // Changed from "SearchTerm"
